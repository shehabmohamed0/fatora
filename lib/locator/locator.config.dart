...
import '../features/auth/domain/usecases/link_email_and_password.dart' as _i17;
...
import '../features/auth/domain/usecases/sign_in_with_phone.dart' as _i23;
import '../features/auth/domain/usecases/verify_phone_number.dart' as _i25;
import '../features/auth/presentation/bloc/app_status/app_bloc.dart' as _i26;
import '../features/auth/presentation/bloc/sign_in/phone/phone_sign_in_cubit.dart'
    as _i29;
import '../features/auth/presentation/bloc/sign_in/sign_in_cubit.dart' as _i30;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i17.LinkEmailAndPassword>(
      () => _i17.LinkEmailAndPassword(get<_i15.AuthRepository>()));
  ...
  gh.lazySingleton<_i23.SignInWithPhone>(
      () => _i23.SignInWithPhone(get<_i15.AuthRepository>()));
  gh.factory<_i24.SignUpFormCubit>(
      () => _i24.SignUpFormCubit(get<_i18.PhoneSignUp>()));
  gh.lazySingleton<_i25.VerifyPhoneNumber>(
      () => _i25.VerifyPhoneNumber(get<_i15.AuthRepository>()));
  gh.factory<_i26.AppBloc>(
      () => _i26.AppBloc(authRepository: get<_i15.AuthRepository>()));
  gh.factory<_i27.CompleteFormCubit>(
      () => _i27.CompleteFormCubit(get<_i17.LinkEmailAndPassword>()));
  gh.factory<_i28.OTPCubit>(() => _i28.OTPCubit(
      verifyPhoneNumber: get<_i25.VerifyPhoneNumber>(),
      phoneSignUp: get<_i18.PhoneSignUp>()));
  gh.factory<_i29.PhoneSignInCubit>(() => _i29.PhoneSignInCubit(
      get<_i25.VerifyPhoneNumber>(), get<_i23.SignInWithPhone>()));
